...
import {FaTimes, FaGithub, FaLinkedin, FaFacebook, FaInstagram, FaTwitter, FaWhatsapp} from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    <div className={!showShadowNav ? 'fixed w-full h-[70px] flex justify-between items-center px-4 bg-gray-900 text-white z-20':'fixed w-full h-[80px] flex justify-between items-center px-4 bg-gray-900 text-white z-20 shadow-2xl'}>
      <div>
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://www.linkedin.com/in/ndung-u-njau-18b108258?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://www.facebook.com/profile.php?id=100086191556409&mibextid=rS40aB7S9Ucbxw6v"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://wa.me/254796116558?text=Hello%2C%20I%27m%20interested%20in%20your%20services"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://github.com/NdunguNjau"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="mailto:johnndungu2040@gmail.com"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
